...
const HomeView = () => {
  return <div className="d-flex justify-content-center align-items-center h-100 px-3">
    <div className={`card text-center p-5 ${style.homeCard}`}>
      ...
      <p className="lead mb-4">En partageant vos pensées à travers ce sondage, vous contribuez à influencer des décisions importantes, services et expériences qui vous concernent directement. Votre voix fait la différence, et chaque réponse compte.</p>
