...
const CompletedView = () => {
    ...
    return <div className="d-flex justify-content-center align-items-center h-100 px-3">
        <div className={`card text-center p-5 ${style.completedCard}`}>
            ...
            <p className="lead">Vous pourrez consulter ultérieurement vos réponses via ce lien : <a href={`http://localhost:5173/answers/${token}`}>http://localhost:5173/answers/{token}</a></p>
        </div>
    </div>
}
